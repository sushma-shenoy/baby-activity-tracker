...
export class CaregiverInvitePage implements OnInit {
  ...
  sendEmail(): void {
    ...
    const subject = 'You’re invited to Gigglebean';
    const body = [
      'Gigglebean',
      ...
      '',
      'You are invited to join a family account in Gigglebean as a caregiver.',
